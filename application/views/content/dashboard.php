            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-6 col-md-4 text-center">
                  <input type="text" class="knob" id="lorem" value="0" data-width="200" data-height="200" data-angleOffset="-125" data-angleArc="250" data-readonly="true">

                  <div class="knob-label">Data Pengukuran Lorem</div>
                </div>
                <div class="col-xs-6 col-md-4 text-center">
                  <input type="text" class="knob" id="ipsum" value="50" data-width="200" data-height="200" data-angleOffset="-125" data-angleArc="250" data-fgColor="yellow" data-readonly="true">

                  <div class="knob-label">Data Pengukuran Ipsum</div>
                </div>
                <div class="col-xs-6 col-md-4 text-center">
                  <input type="text" class="knob" id="dolor" value="100" data-width="200" data-height="200" data-angleOffset="-125" data-angleArc="250" data-fgColor="red" data-readonly="true">

                  <div class="knob-label">Data Pengukuran Dolor</div>
                </div>
              </div>
              <!-- /.row -->
            </div>
  ...
  $(function () {
    ...
    function runChart() {
      ...
      fetchFromServer = function() {
        ...
        var z = Math.floor((Math.random() * -6)+3);
        var val1 = parseInt($("#lorem").val())+x;
        var lorem = valDeter(val1);
        var val2 = parseInt($("#ipsum").val())+y;
        var ipsum = valDeter(val2);
        var val3 = parseInt($("#dolor").val())+z;
        var dolor = valDeter(val3);

        console.log(ipsum);
        $("#lorem").trigger('configure', {'fgColor':lorem.color});
        $("#lorem").val(lorem.val).trigger('change');
        $("#ipsum").trigger('configure', {'fgColor':ipsum.color});
        $("#ipsum").val(ipsum.val).trigger('change');
        $("#dolor").trigger('configure', {'fgColor':dolor.color});
        $("#dolor").val(dolor.val).trigger('change');
      }
      setInterval( function () { fetchFromServer() }, 1000 ); 

      loadToChart = function() {
      }
      //setInterval( function () { loadToChart() } ,200); 

      function valDeter (val) {
        if(val < 0){
          val = 0;
          color = 'green';
